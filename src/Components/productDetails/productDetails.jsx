...
export default function ProductDetails() {
  ...
  <div className="w-full h-64 md:w-3/12 lg:h-96 md:mb-0 mb-4">
    <ImgSlider imgs={product?.images} answer={true} showArrows={false} />
  </div>
  <div className="w-full max-w-lg md:mx-auto mx-0 sm:mt-[30rem] md:mt-0 mt-[10rem] md:w-9/12">
    <h3 className="dark:text-white text-gray-700 uppercase text-lg mb-2">{product?.title}</h3>
    <span className="dark:text-white text-gray-500 block mb-3">${product?.price}</span>
    <hr className="my-3" />
    <div className="mt-2">
      <h3 className="text-gray-700">Rating:</h3>
